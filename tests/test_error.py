...
def test_code_negative() -> None:
    ...
    with pytest.raises(lintkit.error.CodeNegativeError):
        ...
        class A(lintkit.rule.Node, code=-1):  # pyright: ignore[reportImplicitAbstractClass, reportUnusedClass]
...
def test_code_missing() -> None:
    ...
    with pytest.raises(lintkit.error.CodeMissingError):  # noqa: PT012
        ...
        class B(lintkit.check.Contains, lintkit.loader.File, lintkit.rule.Node):  # pyright: ignore[reportIncompatibleMethodOverride]
